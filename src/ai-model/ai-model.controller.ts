...
export class AiModelController {
    ...
    @ApiResponse({ status: 201, description: 'The AI model has been successfully created.', type: CreateAiModelDto }) // Use appropriate DTO/Entity type
    ...
    @ApiResponse({ status: 200, description: 'List of all AI models.', type: [CreateAiModelDto] }) // Use appropriate DTO/Entity type
    ...
    @ApiResponse({ status: 200, description: 'The found AI model record', type: CreateAiModelDto }) // Use appropriate DTO/Entity type
    ...
    @ApiParam({ name: 'id', description: 'AI Model CUID', type: String })
    @ApiResponse({ status: 200, description: 'The AI model has been successfully updated.', type: CreateAiModelDto }) // Use appropriate DTO/Entity type
    @ApiResponse({ status: 404, description: 'AI Model not found.' })
    @ApiResponse({ status: 400, description: 'Bad Request.' })
    @ApiResponse({ status: 409, description: 'Conflict. AIModel with this name already exists.' })
    ...
    @ApiParam({ name: 'id', description: 'AI Model CUID', type: String })
    @ApiResponse({ status: 200, description: 'The AI model has been successfully deleted.', type: CreateAiModelDto }) // Use appropriate DTO/Entity type
    @ApiResponse({ status: 404, description: 'AI Model not found.' })
