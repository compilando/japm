...
export class AiModelService {
  ...
  async create(
    ...
    try {
      ...
      this.logger.error(
        `Error creating AIModel for project ${projectId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async update(
    ...
    try {
      ...
      this.logger.error(
        `Error updating AIModel ${aiModelId} for project ${projectId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async remove(projectId: string, aiModelId: string): Promise<AIModel> {
    ...
    try {
      ...
      this.logger.error(
        `Error deleting AIModel ${aiModelId} for project ${projectId}: ${error.message}`,
        error.stack,
      );
      throw error;
    }
