...
export class TagController {
  ...
  @ApiParam({ name: 'projectId', description: 'ID del proyecto', type: String })
  @ApiResponse({ status: 200, description: 'Lista de etiquetas.', type: [TagDto] })
  @ApiResponse({ status: 404, description: 'Proyecto no encontrado.' })
  ...
  @ApiResponse({ status: 200, description: 'Etiqueta encontrada.', type: TagDto })
  ...
  @ApiResponse({ status: 200, description: 'Etiqueta actualizada.', type: TagDto })
  @ApiResponse({ status: 404, description: 'Proyecto o Etiqueta no encontrada.' })
  @ApiResponse({ status: 400, description: 'Datos inválidos.' })
  ...
  update(
    ...
    const projectId = req.projectId;
    this.logger.debug(`[update] Received PATCH for projectId: ${projectId}, tagId: ${tagId}. Body: ${JSON.stringify(updateDto, null, 2)}`);
  ...
  @ApiResponse({ status: 200, description: 'Etiqueta eliminada.', type: TagDto })
  @ApiResponse({ status: 404, description: 'Proyecto o Etiqueta no encontrada.' })
