...
export class CreatePromptTranslationDto {
    @ApiProperty({ description: 'ID de la versión del prompt a la que pertenece esta traducción', example: 'cl...........cuid' })
    @IsString()
    @IsNotEmpty()
    versionId: string; // FK a ConversationPromptVersion.id
