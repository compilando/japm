...
class AssetVersionLinkDto {
    @ApiProperty({ description: 'ID de la ConversationPromptAssetVersion a vincular.' })
    @IsString()
    @IsDefined()
...
// DTO anidado para traducciones iniciales (igual que en CreateConversationPromptDto)
