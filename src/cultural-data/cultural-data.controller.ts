...
export class CulturalDataController {
    ...
    @ApiParam({ name: 'projectId', description: 'Project ID', type: String })
    @ApiParam({ name: 'culturalDataId', description: 'Key of the cultural data (e.g., direct-and-formal)', type: String })
    ...
    @ApiParam({ name: 'projectId', description: 'Project ID', type: String })
    @ApiParam({ name: 'culturalDataId', description: 'Key of the cultural data to update (e.g., direct-and-formal)', type: String })
    ...
    @ApiParam({ name: 'projectId', description: 'Project ID', type: String })
    @ApiParam({ name: 'culturalDataId', description: 'Key of the cultural data to delete (e.g., direct-and-formal)', type: String })
